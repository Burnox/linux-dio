...
echo "Criando os usuários e adicionando eles nos grupos"
...
useradd roberto -m -s /bin/bash -p $(openssl passwd -crypt teste123) -g GRP_SEC

echo "Especificando os donos"
